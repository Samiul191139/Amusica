...
intents.presences = True # ADDITION
intents.voice_states = True # ADDITION
...
async def handle_join(interaction: discord.Interaction): # MODIFIED
    ...
    if user_voice_state and user_voice_state.channel:
        ...
        if interaction.guild.voice_client is None:
            try:
                ...
                await interaction.followup.send("Failed to join voice channel: Connection timed out.")
